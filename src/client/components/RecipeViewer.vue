<template>
    <div class="recipeViewer" v-on="$listeners">
        <RecipePlaces ref="input" :model="model" :changeable="changeable" prop="input" :forbiddenModels="forbiddenInputTypes" :itemFilter="itemFilter" />
        ...
        <RecipePlaces ref="output" :model="model" :changeable="changeable" prop="output" align="right" :forbiddenModels="forbiddenOutputTypes" :itemFilter="itemFilter" />
        <slot></slot>
    </div>
</template>
